...
getLincRNAPvalue<-function(inputDir,tumorType,mutationType,reSampleIter=1000,seedNum=42,debugMode=FALSE){
...
reducedFunseqOutputNCDS<-reducedFunseqOutputNCDS[grep("lincRNA",reducedFunseqOutputNCDS$NCENC),]
...
reducedFunseqOutputNCDS$GENEparsed<-parseFunseqNCENCField(field=reducedFunseqOutputNCDS$NCENC,keyword="lincRNA")
